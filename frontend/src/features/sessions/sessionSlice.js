...
export const getSessions= createAsyncThunk('sessions/getAll',async(__,thunkAPI)=>
{
    try{
...
export const getSessionById=createAsyncThunk('session/getOne',async(sessionId,thunkAPI)=>
{
    try
    {
...
export const deleteSession=createAsyncThunk('session/delete',async(sessionId,thunkAPI)=>
{
    try
    {
...
//             .addCase(getSessions.fulfilled, (state, action) => {
//   state.isLoading = false;
//   state.sessions = Array.isArray(action.payload)
//     ? action.payload
