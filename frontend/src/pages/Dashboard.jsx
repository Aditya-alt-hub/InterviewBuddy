...
// const TYPES = [{ label: 'coding', value: 'coding' }, { label: 'Technical', value: 'Technical' }, {label:'HR', value:'HR'}];
...
//         <div>
//           <h1 className="text-2xl sm:text-4xl font-black text-slate-900 tracking-tight">Welcome, <span className="text-teal-600">{user?.name ? user.name.split(" ")[0] : "User"}</span> </h1>
